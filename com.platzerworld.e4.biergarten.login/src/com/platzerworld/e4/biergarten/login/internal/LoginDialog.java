...
package com.platzerworld.e4.biergarten.login.internal;
...
public class LoginDialog extends Dialog {
	...
	protected Composite createContentArea(Composite parent) {
		...
		if (imageDescriptor == null) {
			imageDescriptor = imageDescriptorFromURI(URI.createURI("platform:/plugin/com.platzerworld.e4.biergarten.login/images/juno.png"));
		}
		if (imageDescriptor != null) {
